...
const createOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield OrderService.createOrderInDB(orderData);
        res.status(200).json({
            success: true,
...
const getAllOrders = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield OrderService.getAllOrdersFromDB();
        res.status(200).json({
            success: true,
...
const getSingleOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield OrderService.getSingleOrderFromDB(userId);
        res.status(200).json({
            success: true,
